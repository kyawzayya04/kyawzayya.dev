  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 flex flex-col space-y-8">
        ...
        {/* tech-stacks */}
        <div className="rounded-xl border-blue-500 border p-8 hover:translate-y-1 hover:shadow-[2px_2px_8px_rgba(59,130,246,0.2)] transition-all ease-in">
          <p className="text-gray-300 mb-5 md:mb-0">
            An enthusiastic full-stack developer passionate about crafting
            innovative and remarkable projects through :
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* frontend */}
            <div className="rounded-xl p-6 hover:-translate-y-1 transition-all ease-in">
              ...
              <div className="flex flex-wrap gap-2">
                {!!frontendSkills &&
                  frontendSkills.map((tech, key) => (
                    <span
                      key={key}
                      className="bg-gradient-to-r from-blue-600/10 to-cyan-400/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:from-blue-600/20 hover:to-cyan-400/20 hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition cursor-default"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
          ...
          <div className="space-y-7">
            {/* Schools */}
            <div className="p-6 rounded-xl border-blue-500 border hover:-translate-y-1 hover:shadow-[2px_2px_8px_rgba(59,130,246,0.2)] transition">
          ...
          <div>
            <div className="p-6 rounded-xl border-blue-500 border hover:-translate-y-1 hover:shadow-[2px_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-8">💼 Work Experiences</h3>
                    ...
                    >
                      <div className="flex justify-center items-center space-x-3 py-2 mb-2">
                        ...
                        <div className="w-full">
                          <h4 className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent font-bold">
                            <a href={work.url} target="_blank">
                              {work.title}
                            </a>
                          </h4>
                          <span className="inline-block text-[10px] md:text-[12px] font-bold bg-gradient-to-r from-blue-600/70 to-cyan-500/70 px-2 py-1 rounded-full mt-2">
                            Duration :{" "}
